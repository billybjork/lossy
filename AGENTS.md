...
This is a **Phoenix + Chrome Extension** project that captures voice feedback while watching videos and automatically posts structured, time-coded notes to video platforms.
...
- **Backend:** Phoenix LiveView (streaming UI), Channels (audio), Oban (job queue), Browserbase (automation)
- **Frontend:** Chrome MV3 (Side Panel API), LiveView client, Shadow DOM overlays
- **Future:** WASM Whisper (local STT), Transformers.js (local vision models)

...
export class ProgressBarFinder {
   ...
   * Uses multiple generic strategies in order of reliability.
   */
  find() {
    console.log('[ProgressBarFinder] Searching for progress bar...');
    ...
    if (rangeInputs.length > 0) {
      console.log('[ProgressBarFinder] Found via range input');
    ...
    if (candidate) {
      console.log('[ProgressBarFinder] Found via visual heuristics');
      return candidate;
    }
